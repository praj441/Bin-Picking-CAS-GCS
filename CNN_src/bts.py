...
class bts(nn.Module):
    ...
    def forward(self, features, focal):
        ...
        # aux_features.append(iconv3)

        # aux_features['0'] = concat3
        # aux_features['1'] = concat4
        # aux_features['2'] = concat5
        # aux_features['3'] = dense_features

        aux_features['0'] = skip1
        aux_features['1'] = skip2
        aux_features['2'] = skip3
        aux_features['3'] = dense_features
        ...
        print('max_depth',self.params.max_depth)
        ...
        return depth_8x8_scaled, depth_4x4_scaled, depth_2x2_scaled, reduc1x1, final_depth, aux_features
...
class BtsModel(nn.Module):
    def __init__(self, params,out_channels,focal):
        # print('************************BTS Init*********************')
    ...
    def forward(self, x):
        ...
        # for i,feature in enumerate(skip_feat):
        #     print(i,feature.shape)
        out_list = self.decoder(skip_feat, self.focal)
        self.final_depth = out_list[4]
        features = out_list[5]
        return features
